...
export const PROJECTS: Project[] = [
  ...
  {
    title: 'Ticket-Blitz (High-Concurrency Booking)',
    description: 'An event booking platform designed to handle high traffic. Solves the "Double Booking" problem using Redis for distributed locking and Optimistic Locking for database integrity.',
    techStack: ['Java', 'Spring Boot', 'Redis', 'MySQL', 'Hibernate'],
    link: 'https://github.com/kamalesh574/Ticket-Blitz-Backend',
    demoLink: 'https://ticket-blitz-demo.com',
  },
  {
    title: 'Edu-Nexus (LMS Platform)',
    description: 'A comprehensive Learning Management System with strict Role-Based Access Control (RBAC). Features secure video streaming, progress tracking, and instructor dashboards.',
  ...
  // --- FRONTEND BASED (The "Visual & Logic" Projects) ---
  {
    ...
    description: 'Interactive dashboard visualizing complex sorting and pathfinding algorithms (BFS, Dijkstra). Features dynamic speed control, step-by-step execution, and complexity analysis.',
  ...
  },
  {
    ...
    description: 'A "Zero-Hunger" marketplace connecting restaurants with NGOs. Handles real-time inventory tracking, expiration alerts, and distinct dashboards for donors and receivers.',
